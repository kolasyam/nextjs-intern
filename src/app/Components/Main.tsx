...
export default function Main() {
  ...
  return (
    <section id="Main" className="text-gray-600 body-font" ref={sectionRef}>
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center mt-9">
          ...
          <h1 className="py-2 text-4xl font-bold md:text-6xl">
            Syam Manikanta
          </h1>
          ...
          <p className="mb-5 leading-relaxed">
            ...
            stunning but also perform smoothly across different browsers and
            devices.
          </p>
          <p className="mb-8 leading-relaxed">
            If you scroll down a bit, you can check out some of my recent
            projects and see what Ive been up to
          </p>
        ...
        <div className="lg:max-w-lg lg:w-[30%] lg:mr-7 md:w-1/2 w-[50%] hover:scale-105 ease-in duration-300 mt-12">
          <Image src={home} alt="/" width="720" height="400" />
        </div>
      </div>
    </section>
  );
